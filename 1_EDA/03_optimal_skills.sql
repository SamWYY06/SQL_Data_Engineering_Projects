/*
    What are the most optimal skills for data engineers - balancing both demand and salary?
        - Create a rankin column that combines demand count and meadian salary to identify the most valuable skills
        - Focus only on remote Data Engineer positions with specified annual salaries
        -Why?
            - This approach highlights skills that balance market demand and financial reward.
            It weights core skills appropriately, providing a more holistic view of the most valuable skills for data engineers seeking remote work.
*/
